...
import { about, becomeInstructor, moderator, privacyPolicy, reportBug } from '../fixedRoutes';
...
const OptionsMenu = ({
	...
	return (
		<Menu
			...
			<MenuItem dense component={Link} to={moderator} onClick={handleMenuClose}>
				<ListItemIcon>
					<SupervisorAccountIcon />
				</ListItemIcon>

				<ListItemText primary='Moderator Panel' />
			</MenuItem>
